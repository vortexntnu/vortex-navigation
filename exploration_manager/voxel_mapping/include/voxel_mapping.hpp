...
class VoxelMapping {
public:
    VoxelMapping(float resolution, uint size_x, uint size_y, uint size_z, float min_depth, float max_depth, float log_odds_occupied, float log_odds_free, float log_odds_min, float log_odds_max);
    VoxelMapping();
    ~VoxelMapping();
    void set_K(float fx, float fy, float cx, float cy);
    void set_image_size(int width, int height);
    void set_log_odds_properties(float log_odds_occupied, float log_odds_free, float log_odds_min, float log_odds_max);
...
private:
    ...
    float log_odds_occupied_, log_odds_free_, log_odds_min_, log_odds_max_;
};
